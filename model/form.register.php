<form id="form" data-parsley-validate="" novalidate="" method="post" action="control/script.register.php">
      <div class="form-group row">
          ...
          <div class="col-xl-10">
              <input required hidden type="text" name="id" value="<?php echo autokode("pengguna", date("Y-m-d")."-"); ?>">
      ...
      <div class="form-group row">
          <label class="col-lg-2 col-form-label text-right"><i class="fas fa-map"></i></label>
          <div class="col-xl-10">
              <textarea class="form-control" name="address" required="" rows="8" cols="80">Masukkan alamat</textarea>
          </div>
      </div>
      <div class="form-group row">
