...
if (empty(@$_SESSION['admin_username'])) {
  ...
  window.location.replace('$pageLogin?admin');</script>";
}
?>
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Whoop ! Admin  [<?php echo $titlePage; ?>]</title>
    <!-- Bootstrap CORE -->
    ...
    <link rel="stylesheet" href="<?php echo $framework; ?>summernote/css/summernote-bs4.css">
    <!-- Style Plugin -->
