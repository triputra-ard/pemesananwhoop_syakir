<div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
  <?php if (isset($_GET['sort'])): ?>
    ...
    LIMIT $start,$paging";
    $mysql = mysqli_query($db,$sqlfetch);?>
              ...
              <div class="product-thumbnail">
                  ...
                  <div class="product-content">
                      ...
                      <div class="product-btn">
                          <a href="package.reservation?reservation=<?php echo encrypt($package['id_paket']); ?>" class="btn btn-primary">Buat Reservasi</a>
  ...
  <?php else: ?>
    ...
    $queryresult = mysqli_query($sqlresult) or die (mysqli_error($db));
    $totalpage = mysqli_num_rows($queryresult);
    $pagination = ceil($totalpage/$paging);
