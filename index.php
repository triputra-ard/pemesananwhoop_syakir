                  ...
                  <div class="card-body">
                      <div id="carousel" class="carousel slide" data-ride="carousel">
                          <ol class="carousel-indicators">
                            ...
                            $mysqlhome = mysqli_query($db, $sqlhomepage);
                            $count = mysqli_result($mysqlhome,0);

                            for ($r=0; $r < $count ; $r++) {
                            ?>
                              <li data-target="#carousel" data-slide-to="<?php echo $r; ?>" class="<?php if($r == 0 ) echo "active"; ?>"></li>
                            <?php } ?>
                          </ol>
                          <div class="carousel-inner">
                            ...
                            $querypict = mysqli_query($db, $sqlpict);
                            while ($packagehome = mysqli_fetch_assoc($querypict)) {
                             ?>
                              <div class="carousel-item <?php if($number++ === 0) echo 'active'; ?>">
                                  <img class="d-block w-100" src="<?php echo $pictLink.$packagehome['foto_1']; ?>" alt="<?php echo $number++; ?> slide">
            ...
            <div class="row">
              <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
                  <div class="row">
                      ...
                      $querypopular = mysqli_query($db, $sqlpopular);
                      while ($popular = mysqli_fetch_assoc($querypopular)) {
                       ?>
